...
export const metadata: Metadata = {
  title: "Profile Page | Automated Vulnerability Scanner",
  description: "This is Profile page for GUI for Scanner Next.js",
  // other metadata
};
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Cybersecurity Admin</p>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                Hi there, I am Cybersecurity Admin. I like help people build
                their dream SaaS/Website. The technlogies I&#39m specializes is
