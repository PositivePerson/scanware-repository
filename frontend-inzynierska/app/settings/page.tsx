...
export const metadata: Metadata = {
  title: "Settings Page | Automated Vulnerability Scanner",
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          name="fullName"
                          id="fullName"
                          placeholder="Bartosz Student"
                          defaultValue="Bartosz Student"
                        />
                      </div>
                    </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        defaultValue="264046@student.pwr.edu.pl"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        defaultValue="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum blandit aliquet. Pellentesque posuere fermentum urna, eu condimentum mauris tempus ut."
                      ></textarea>
                    </div>
                  </div>
