...
def get_nvt_aggregates():
    ...
    try:
        with Gmp(connection=connection, transform=transform) as gmp:
            ...
            # Use get_aggregates to fetch NVTs grouped by severity
            ...
            for group in aggregates_response.xpath('aggregate/group'):
                ...
                severity_value = group.findtext('value', default="N/A")
            ...
            return json.dumps(nvt_data, indent=2)
